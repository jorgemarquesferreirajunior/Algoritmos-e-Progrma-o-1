...
inicio:
			...
			movlw		H'FF'			; W = B'11111111' movendo o valor H'7F' ao registrador de trabalho
			movwf		PORTB			; PORTB = H'F'iniciando em HIGH para as saidas configuradas no TRISB
			
;			goto 		$				; loop infinito (segura o codigo nesta linha)
loop:
			btfsc		botao1			; testa se o botao em pull up foi presionado
			goto		apaga_led1		; nao foi pressionado, desvia para a etapa apaga_led1
			bsf			led1			; botao pressionado, liga o led

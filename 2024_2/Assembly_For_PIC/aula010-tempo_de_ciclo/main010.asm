...
delay500ms:
			movlw		D'200'			; W = 200
			movwf		H'0C'			; salva o valor 200 no endereco H'0C'
										; 2 ciclos gastos
			
aux1:
			movlw		D'250'			; w = 250
			movwf		H'0D'			; salva o valor 250 o endereco H'0D'
										; 2 ciclos gastos
aux2:
			...
			decfsz		H'0D'			; decrementa uma unidade do valor salvo no endero H'0D'
			...
			decfsz		H'0C'			; decrementa uma unidade do valor salvo no endero H'0C'
